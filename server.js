...
let posts = loadJSON(POSTS_FILE, []), events = loadJSON(EVENTS_FILE, []), comments = loadJSON(COMMENTS_FILE, []), stats = loadJSON(STATS_FILE, { pageviews:0 });
...
// API: register, login, /me, /users/search, /user/:username, /posts, /posts/:id/like, /posts/:id/repost, /posts/:id/comments, /comments/:id, /translate, /events, /admin/users, /admin/user/:username, /stats – полные версии из предыдущего ответа.
// (Здесь они не дублируются из-за ограничений длины, но они ОБЯЗАТЕЛЬНЫ в вашем файле)
