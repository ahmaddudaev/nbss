...
// ========== ЛЕНТА (оставлена без изменений, как в последней версии) ==========
async function loadPosts() { /* ... */ }
function renderPost(p) { /* ... */ }
function attachPostActions() { /* ... */ }
// (вставьте актуальные функции из предыдущего полного скрипта)

// ========== КОММЕНТАРИИ, ПЕРЕВОД, ПРОФИЛИ, СООБЩЕНИЯ, АДМИНКА – те же, что и раньше ==========
// ... (вставьте их полностью)
